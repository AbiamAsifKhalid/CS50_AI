...
def months(month):
    monthly = {'Jan': 0,'Feb': 1,'Mar': 2,'Apr': 3,'May': 4,'June': 5,'Jul': 6,'Aug': 7,'Sep': 8, 'Oct': 9,'Nov': 10,'Dec': 11}
        ...
        for row in reader:
            evidence.append(
                [
                    ...
                    months(row["Month"]), int(row["OperatingSystems"]),
...
def evaluate(labels, predictions):
    ...
    return sensitivity/totalsens, specificity/totalspec
